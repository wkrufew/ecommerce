<div x-data>
    <p class="text-sm font-semibold pb-4">Stock: <span class="text-[#60A3BD]">
        {{$quantity}}
    </span></p>
    <div class="flex">
        <div class="flex items-center mr-5">
            ...
            <button disabled x-bind:disabled="$wire.qty >= $wire.quantity" wire:loading.attr="disabled" wire:target="increment" wire:click="increment" wire:click="increment" class="disabled:bg-gray-300 disabled:cursor-not-allowed disabled:text-gray-400 disabled:fill-gray-400 disabled:border-gray-400 border w-10 h-10 border-[#60A3BD] rounded-full hover:bg-[#60A3BD] hover:text-white text-[#60A3BD]">
                +
            </button>
        </div>
        <div class="flex-1 items-center">
            <button disabled x-bind:disabled="$wire.qty > $wire.quantity" {{-- wire:loading.remove --}} wire:click="addItem" class="disabled:bg-gray-300 disabled:cursor-not-allowed disabled:text-gray-400 disabled:fill-gray-400 disabled:border-gray-400 w-full flex justify-center items-center border border-[#60A3BD] text-[#60A3BD] hover:bg-[#60A3BD] fill-[#60A3BD] hover:fill-white rounded-full px-3 py-2 hover:text-white">
                <span class="mr-2">
