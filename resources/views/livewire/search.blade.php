<div class="w-full md:w-72 h-full rounded-full relative mx-2 md:mx-0">
    <div class="">
        <form action="{{ route('search') }}" autocomplete="off">
            ...
            <div class="absolute inset-y-0 right-1 md:right-0.5 flex items-center pointer-events-auto cursor-pointer">
                <svg class="h-7 w-7 p-1.5 flex justify-center items-center text-[#60A3BD] bg-gray-200 rounded-full" viewBox="0 0 24 24" fill="none">
