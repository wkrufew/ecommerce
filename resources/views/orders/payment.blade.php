<x-app-layout>
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 mt-10">
        ...
        <div>
            agregar el detalle de la compra como precio cargo de envio y Descuentos
        </div>
