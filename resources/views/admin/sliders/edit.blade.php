    ...
    <div class="max-w-5xl mx-auto p-6 bg-white rounded-md mt-10">
        <form action="{{ route('admin.sliders.update', $slider) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <x-input type="text" name="url" id="url" class="w-full" value="{{ $slider->url }}" placeholder="Ingrese la URL de redireccion" />
            ...
            <div class="flex justify-center py-4">
                @if ($slider->imagen)
                    ...
                    src="{{Storage::url($slider->imagen)}}" width="300px" alt="">
                @else
                    <img id="picture" style="border-radius: 8px;"
