    ...
    <div class="container px-6 py-8 mx-auto">
            ...
            <div class="flex sm:items-center sm:justify-center space-x-4 mt-4">
                ...
                @if (isset($settings['phone2']))
                    <span class="flex items-center justify-center">
                        ...
                        @endphp
                        <a href="https://api.whatsapp.com/send?phone={{ $settings['phone2']}}&text={{$mensajeReemplazado}}" target="_blank" rel="noopener noreferrer">
        ...
        <div class="flex flex-col items-center sm:flex-row sm:justify-between">
            ...
            <div class="flex mt-3 -mx-2 sm:mt-0">
                <a href="https://www.facebook.com/smith.aviles3" target="_blank" class="mx-2 text-xs md:text-sm text-white transition-colors duration-300 hover:text-[#60A3BD]" aria-label="Reddit"> <b>Desarrollador:</b> Ing. Smith Aviles </a>
            </div>
        </div>
    </div>
</footer>